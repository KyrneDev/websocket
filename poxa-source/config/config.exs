...
config :poxa,
  port: get_env("POXA_PORT", "8080") |> String.to_integer(),
...
config :poxa, :ssl,
  ...
  port: get_env("POXA_PORT", "8443") |> String.to_integer(),
  cacertfile: get_env("POXA_SSL_CACERTFILE", ""),
  certfile: get_env("POXA_SSL_CERTFILE", ""),
  keyfile: get_env("POXA_SSL_KEYFILE", "")
