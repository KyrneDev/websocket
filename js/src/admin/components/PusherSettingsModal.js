...
export default class PusherSettingsModal extends SettingsModal {
  ...
  form() {
    return [
      ...
      <div className="Form-group">
        <BooleanItem setting={this.setting} name={'kyrne-websocket.auth_only'} cast={Number}>
          <label>{app.translator.trans('kyrne-websocket.admin.pusher_settings.auth_only')}</label>
        </BooleanItem>
